...
import 'package:fall_2023_project/header.dart';
import 'package:fall_2023_project/page/profile_page.dart';
import 'package:fall_2023_project/page/settings_page.dart';
          ...
          body: NestedScrollView(
            ...
            headerSliverBuilder: (context, innerBoxIsScrolled) => [
              SliverAppBar(
                ...
                title: Column(
                  children: [
                    const Header('assets/avatar.png'),
                    Text(
                      _username,
